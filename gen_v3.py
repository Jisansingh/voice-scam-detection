...
en_templates = {
    ...
    'courier': ["arey courier booked hai pickup tomorrow aayega", "bhai tracking number check karo live location dekho", "tu package deliver kar diya receiver ne sign kiya", "arey delivery delayed hai weather ke karan hai", "bhai international shipping ka charges calculate karo", "arey fragile item hai proper packing karo", "courier boy ne call kiya address confirm karo", "bhai order ki delivery 2 days mein hogi", "arey wrong address diya hai correction karo", "package lost ho gaya hai complaint file karo"],
...
hi_templates = {
    'family': ["abhi kaun sa time ho raha hai", "ghar wapas kab aoge", "mummy ne khana banaaya hai", "papa ka phone answering nahi ho raha", "dada ji ki health theek hai", "behen ki shaadi ki taiyari kaise chal rahi hai", "chacha ji ne poochha aapka number", "bhai log bahut miss kar rahe hain", "nani ji ne bahut yaad kiya", "arey behen ka exam kab hai", "papa ne kaha bus ticket book karo", "dadi ne phone pe baat ki"],
    'friend_chat': ["kal raat ki party mein aoge", "tu kaha busy hai itna", "movie dekhne chalte hain na", "cafe mein chill karne chalte hain", "bhai tune naya number save kiya kya", "placement ki news mil gayi", "sirf tum hi nahi sab missing kar rahe hain", "gym chalte hain aaj", "cricket match dekhne jaate hain", "arey bahut maza aayega"],
    'student': ["exam ka date sheet aaya hai", "assignment ki deadline badh gayi", "library mein jaldi jaana padega", "notes ki xerox karwani hai", "semester fee last date kal tak hai", "attendance ki problem ho gayi hai", "placement ki preparation shuru karo", "project ki presentation date confirm hui", "mess ka food bahut bekaar ho gaya", "hostel ki room change karni hai"],
    'office': ["meeting mein attendance zaruri hai", "report ki last date aaj hai", "client se call aana chahiye", "boss ne naya kaam diya hai", "work from home ki request bhejni hai", "team ki performance improve karni hai", "salary slip download karni hai", "leave application submit karni hai", "project deadline aaj hai", "new policy ke baare mein info chahiye"],
    'delivery': ["delivery boy bahar khada hai", "order cancel karni hai", "tracking number check karna hai", "package thoda damage ho gaya hai", "wrong item deliver hua hai", "order confirm ho gaya hai", "delivery time 20 minute hai", "grocery items ka bill bana hai", "express delivery lena hai", "return karne ja rahe hain"],
    'shopping': ["sale mein bahut discount mil raha hai", "size exchange karni hai", "clothes ki quality theek nahi hai", "cashback offer chal raha hai", "gift wrapping karwaana hai", "order placed ho gaya hai", "product out of stock hai", "discount coupon apply karna hai", "payment failed ho gaya hai", "wishlist mein add kiya hai"],
    'travel': ["flight ka booking kar liya hai", "train ki waiting hat gayi", "hotel ki confirmation mail aayi", "cab ki booking kar li hai", "travel insurance lena hai", "boarding pass print karna hai", "baggage allowance check karni hai", "visa status online dekhna hai", "refund process ho raha hai", "tour package book karni hai"],
    'food': ["zomato se order kiya hai", "swiggy pe discount mil raha hai", "restaurant mein table book kiya hai", "biryani ka order kiya hai", "home delivery time confirm hai", "diet food order karni hai", "cake order kiya hai birthday ke liye", "thali ka menu dekhna hai", "combo meal lena hai", "pizza ka extra cheese lena hai"],
    'banking': ["atm pin change karni hai", "net banking activate karni hai", "account statement download karni hai", "credit card bill pay karna hai", "loan ke liye apply karna hai", "fd interest rate dekhna hai", "debit card blocked ho gaya hai", "upi payment karni hai", "bank branch jaana padega", "credit score check karni hai"],
    'customer_support': ["customer care se baat karni hai", "service request register karni hai", "refund status pochna hai", "warranty claim karni hai", "subscription renew karni hai", "complaint register karni hai", "technical help chahiye", "installation appointment lena hai", "return policy dekhni hai", "help desk se baat karni hai"],
    'cab_service': ["cab book kar liya hai", "ride cancel karni hai", "driver se call karni hai", "fare estimate dekhna hai", "ride complete ho gaya hai", "extra stops add karni hain", "outstation ride lena hai", "sedan book karna hai", "driver ne route change kiya", "koi item bhul gaya"],
    'courier': ["courier book kar liya hai", "tracking number mil gaya hai", "delivery ho gaya hai", "delivery delayed hai", "shipping charges dekhne hain", "fragile item hai dhyan se pack karo", "pickup time confirm karni hai", "address correction karni hai", "insurance add karni hai", "delivery slot book karni hai"],
    'college': ["fest mein participate karna hai", "attendance maintain karni hai", "club meeting mein aana hai", "bus timing dekhni hai", "registration form fill karna hai", "library card renew karni hai", "mess menu change hua hai", "seminar mein attend karna hai", "sports trials hain", "cultural event ka registration karna hai"],
    'gaming': ["bgmi mein match khelna hai", "free fire ka new update aaya hai", "rank improve karni hai", "new agent try karna hai", "season reset ho gaya hai", "gaming setup upgrade karna hai", "steam sale chal raha hai", "tournament register karna hai", "headphones ki recommendation chahiye", "stream shuru karni hai"],
    'personal': ["kaisa hai tu abhi", "call nahi aaya kya", "time schedule karna hai", "future planning kar raha hoon", "health checkup karaya hai", "hobby shuru karni hai", "self improvement karni hai", "meditation shuru kiya hai", "routine maintain kar raha hoon", "relationships ke baare mein soch raha hoon"]
}

rows = []
seen = set()

target_per_lang_cat = 25
